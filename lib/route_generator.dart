...
import 'src/pages/details_pending_order.dart';
import 'src/pages/help.dart';
import 'src/pages/languages.dart';
import 'src/pages/login.dart';
import 'src/pages/maps.dart';
import 'src/pages/order.dart';
import 'src/pages/order_editor.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      // case '/Map':
      //   return MaterialPageRoute(builder: (_) => MapUtils());
      case '/Pages':
        return MaterialPageRoute(builder: (_) => PagesTestWidget(currentTab: args));
      case '/OrderEditor':
        return MaterialPageRoute(builder: (_) => OrderEditor(routeArgument: args as RouteArgument));
      case '/OrderDetails':
        return MaterialPageRoute(builder: (_) => OrderWidget(routeArgument: args as RouteArgument));
      case '/DetailsPendingOrder':
        return MaterialPageRoute(builder: (_) => DetailsPendingOrder(routeArgument: args as RouteArgument));
      case '/Notifications':
