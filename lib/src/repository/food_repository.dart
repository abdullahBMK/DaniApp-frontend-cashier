...
Future<Stream<Food>> getTrendingFoods() async {
  ...
  final String url = '${GlobalConfiguration().getString('api_base_url')}products?${_apiToken}with=market&limit=6';
...
Future<Stream<Food>> getFood(String foodId) async {
  ...
  final String _apiToken = 'api_token=${_user.apiToken}&';
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}products/$foodId?${_apiToken}with=nutrition;restaurant;category;extras;foodReviews;foodReviews.user';
...
Future<Stream<Food>> getFoodsByCategory(categoryId) async {
  ...
  final String _apiToken = 'api_token=${_user.apiToken}&';
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}products?${_apiToken}with=restaurant&search=category_id:$categoryId&searchFields=category_id:=';
