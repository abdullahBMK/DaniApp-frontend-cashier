...
class _ProfileWidgetState extends StateMVC<ProfileWidget> {
  ...
  void initState() {
    ...
    status = currentUser.restaurant.available;
    super.initState();
  }
                    ...
                    title: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: <Widget>[
                            FlutterSwitch(
                              value: _con.restaurant.available,
                              onToggle: (val) {
                                _con.restaurant = null;
                                setState(() { });
                                _con.listenForUpdateRestaurant(val);
                              },
                            ),
                            Container(
                              alignment: Alignment.centerRight,
                              child: Text(
                               _con.restaurant.available ? "OPEN" : "CLOSE",
                              ),
                            ),
                          ],
                        ),
                          ...
                          itemBuilder: (context, index) {
                            return Theme(
                              ...
                              child: ExpansionTile(
                                ...
                                children:_con.recentOrders.elementAt(index).foodOrders != null ?
