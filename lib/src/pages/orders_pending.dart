...
class OrdersPendingWidget extends StatefulWidget {
  final GlobalKey<ScaffoldState> parentScaffoldKey;

  OrdersPendingWidget({Key key, this.parentScaffoldKey}) : super(key: key);
  @override
  _OrdersPendingWidgetState createState() => _OrdersPendingWidgetState();
}

class _OrdersPendingWidgetState extends StateMVC<OrdersPendingWidget> {
  OrderController _con;
bool refreshState = false;
  _OrdersPendingWidgetState() : super(OrderController()) {
    _con = controller;
  }

  @override
  void initState() {
    _con.listenForPendingOrders();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: _con.refreshPendingOrders,
                        ...
                        return Theme(
                          ...
                          child: ExpansionTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).pushNamed('/DetailsPendingOrder',
